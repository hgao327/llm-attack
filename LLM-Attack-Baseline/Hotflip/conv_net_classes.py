...
# Import pool_2d and conv2d for Theano 1.0.5
from theano.tensor.signal.pool import pool_2d
from theano.tensor.nnet.conv import conv2d

# Import RandomStreams - try multiple locations
RandomStreams = None
try:
    ...
    try:
        ...
        try:
            ...
            # If all imports fail, we'll handle it in the dropout function
            pass
...
"""
    global RandomStreams
    
    if RandomStreams is None:
        # RandomStreams not available, disable dropout
        print("Warning: RandomStreams not available, dropout disabled")
        return layer
...
class MLPDropout(object):
    ...
    def __init__(self,rng,input,layer_sizes,dropout_rates,activations,use_bias=True):
        ...
        self.weight_matrix_sizes = list(zip(layer_sizes, layer_sizes[1:]))  # Convert to list for Python 3
        self.layers = []
        self.dropout_layers = []
